export default function Hero() {
  return (
    <div className="container">
      ...
      <div className="col-6 mt-3 p-5 text-muted">
        <p>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company CashCurve, the Sanskrit word for barrier.</p>
        <br></br>
